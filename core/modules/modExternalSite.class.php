 ...
 * \brief      Module to include an external web site/tools into Berp3 menu and into a frame page.
 ...
 */
class modExternalSite extends Berp3Modules
{
	...
	public function __construct($db)
	{
		...
		$this->description = "This module include an external web site or page into Berp3 menus and view it into a Berp3 frame.";
