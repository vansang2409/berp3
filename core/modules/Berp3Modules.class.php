...
/**
 * \file           htdocs/core/modules/Berp3Modules.class.php
 ...
 */
class Berp3Modules // Can not be abstract, because we need to instantiate it into unActivateModule to be able to disable a module whose files were removed.
{
	/**
	 ...
	 * @see https://bonaerp.com/index.php/List_of_modules_id
	 */
	public $numero;
	 ...
	 * 'development'
	 * 'experimental'
	 * 'berp3': only for core modules that share its version
	 * 'berp3_deprecated': only for deprecated core modules
	 */
	public $version;
	...
	/**
	 * @var array Minimum version of Berp3 required by module.
	 * e.g.: Berp3 ≥ 3.6 = array(3, 6)
	 */
	public $need_berp3_version;
	...
	// We should but can't set this as abstract because this will make berp3 hang
	 ...
	 * For 'berp3' modules, gives Berp3 version
	 *
	...
	{
		if (in_array($this->version, array('berp3', 'experimental', 'development'))) {	// core module
	...
	{
		if ($this->version == 'berp3' || $this->version == 'berp3_deprecated') {
			return 'core';
		}
	 ...
	 * The init function adds tabs, constants, boxes, permissions and menus (defined in constructor) into Berp3 database.
