...
/**
 *	\file       htdocs/core/boxes/box_berp3_state_board.php
 *	\ingroup
 *	\brief      Module Berp3 state base
 */
 ...
 */
class box_berp3_state_board extends ModeleBoxes
{
	public $boxcode = "berp3statebox";
	public $boximg = "generic";
	public $boxlabel = "BoxBerp3StateBoard";
	...
	public function loadBox($max = 5)
	{
		...
		$this->max = $max;
		$this->info_box_head = array('text' => $langs->trans("Berp3StateBoard"));
