...
/**
 * \file 		htdocs/core/db/Berp3DB.class.php
 * \brief 		Class file to manage Berp3 database access
 */

require_once DOL_DOCUMENT_ROOT.'/core/db/Database.interface.php';

/**
 * Class to manage Berp3 database access
 */
abstract class Berp3DB implements Database
{
