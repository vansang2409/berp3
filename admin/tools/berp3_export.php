...
/**
 *		\file 		htdocs/admin/tools/berp3_export.php
 *		\ingroup	core
...
print $langs->trans("BackupDesc3", $berp3_main_db_name).'<br>';
...
print $langs->trans("DatabaseName").' : <b>'.$berp3_main_db_name.'</b><br>';
print '</td>';
print '</tr>';
...
if (!empty($_SESSION["commandbackuptorun"])) {
	print '<br><span class="warning">'.$langs->trans("YouMustRunCommandFromCommandLineAfterLoginToUser", $berp3_main_db_user, $berp3_main_db_user).':</span><br>'."\n";
...
$prefix = 'documents';
$ext = 'zip';
$file = $prefix.'_'.$berp3_main_db_name.'_'.dol_sanitizeFileName(DOL_VERSION).'_'.strftime("%Y%m%d%H%M");
