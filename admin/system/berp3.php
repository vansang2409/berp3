...
/**
 *  \file       htdocs/admin/system/berp3.php
 *  \brief      Page to show Berp3 information
 */
...
if ($action == 'getlastversion') {
	$result = getURLContent('https://sourceforge.net/projects/berp3/rss');
...
print ' &nbsp; <a href="https://raw.githubusercontent.com/Berp3/berp3/'.$version.'/ChangeLog" target="_blank">'.$langs->trans("SeeChangeLog").'</a>';
...
print '<div class="div-table-responsive-no-min">';
print '<table class="noborder centpercent">';
print '<tr class="liste_titre"><td class="titlefieldcreate">'.$langs->trans("LocalisationBerp3Parameters").'</td><td>'.$langs->trans("Value").'</td></tr>'."\n";
...
$txt .= $langs->trans("Berp3 constant MAIN_SERVER_TZ").': '.(empty($conf->global->MAIN_SERVER_TZ) ? $langs->trans("NotDefined") : $conf->global->MAIN_SERVER_TZ);
...
$configfileparameters = array(
	'berp3_main_prod' => 'Production mode (Hide all error messages)',
	'berp3_main_instance_unique_id' => $langs->trans("InstanceUniqueID"),
	'separator0' => '',
	'berp3_main_url_root' => $langs->trans("URLRoot"),
	'?berp3_main_url_root_alt' => $langs->trans("URLRoot").' (alt)',
	'berp3_main_document_root'=> $langs->trans("DocumentRootServer"),
	'?berp3_main_document_root_alt' => $langs->trans("DocumentRootServer").' (alt)',
	'berp3_main_data_root' => $langs->trans("DataRootServer"),
	'separator1' => '',
	'berp3_main_db_host' => $langs->trans("DatabaseServer"),
	'berp3_main_db_port' => $langs->trans("DatabasePort"),
	'berp3_main_db_name' => $langs->trans("DatabaseName"),
	'berp3_main_db_type' => $langs->trans("DriverType"),
	'berp3_main_db_user' => $langs->trans("DatabaseUser"),
	'berp3_main_db_pass' => $langs->trans("DatabasePassword"),
	'berp3_main_db_character_set' => $langs->trans("DBStoringCharset"),
	'berp3_main_db_collation' => $langs->trans("DBSortingCollation"),
	'?berp3_main_db_prefix' => $langs->trans("DatabasePrefix"),
	'berp3_main_db_readonly' => $langs->trans("ReadOnlyMode"),
	'separator2' => '',
	'berp3_main_authentication' => $langs->trans("AuthenticationMode"),
	'?multicompany_transverse_mode'=>  $langs->trans("MultiCompanyMode"),
	'separator'=> '',
	'?berp3_main_auth_ldap_login_attribute' => 'berp3_main_auth_ldap_login_attribute',
	'?berp3_main_auth_ldap_host' => 'berp3_main_auth_ldap_host',
	'?berp3_main_auth_ldap_port' => 'berp3_main_auth_ldap_port',
	'?berp3_main_auth_ldap_version' => 'berp3_main_auth_ldap_version',
	'?berp3_main_auth_ldap_dn' => 'berp3_main_auth_ldap_dn',
	'?berp3_main_auth_ldap_admin_login' => 'berp3_main_auth_ldap_admin_login',
	'?berp3_main_auth_ldap_admin_pass' => 'berp3_main_auth_ldap_admin_pass',
	'?berp3_main_auth_ldap_debug' => 'berp3_main_auth_ldap_debug',
	'separator3' => '',
	'?berp3_lib_ADODB_PATH' => 'berp3_lib_ADODB_PATH',
	'?berp3_lib_FPDF_PATH' => 'berp3_lib_FPDF_PATH',
	'?berp3_lib_TCPDF_PATH' => 'berp3_lib_TCPDF_PATH',
	'?berp3_lib_FPDI_PATH' => 'berp3_lib_FPDI_PATH',
	'?berp3_lib_TCPDI_PATH' => 'berp3_lib_TCPDI_PATH',
	'?berp3_lib_NUSOAP_PATH' => 'berp3_lib_NUSOAP_PATH',
	'?berp3_lib_GEOIP_PATH' => 'berp3_lib_GEOIP_PATH',
	'?berp3_lib_ODTPHP_PATH' => 'berp3_lib_ODTPHP_PATH',
	'?berp3_lib_ODTPHP_PATHTOPCLZIP' => 'berp3_lib_ODTPHP_PATHTOPCLZIP',
	'?berp3_js_CKEDITOR' => 'berp3_js_CKEDITOR',
	'?berp3_js_JQUERY' => 'berp3_js_JQUERY',
	'?berp3_js_JQUERY_UI' => 'berp3_js_JQUERY_UI',
	'?berp3_font_DOL_DEFAULT_TTF' => 'berp3_font_DOL_DEFAULT_TTF',
	'?berp3_font_DOL_DEFAULT_TTF_BOLD' => 'berp3_font_DOL_DEFAULT_TTF_BOLD',
	'separator4' => '',
	'berp3_main_restrict_os_commands' => 'Restrict CLI commands for backups',
	'berp3_main_restrict_ip' => 'Restrict access to some IPs only',
	'?berp3_mailing_limit_sendbyweb' => 'Limit nb of email sent by page',
	'?berp3_mailing_limit_sendbycli' => 'Limit nb of email sent by cli',
	'?berp3_strict_mode' => 'Strict mode is on/off',
	'?berp3_nocsrfcheck' => 'Disable CSRF security checks'
);
...
foreach ($configfileparameters as $key => $value) {
	...
	if (empty($ignore)) {
		...
		if (strpos($newkey, 'separator') !== false) {
			...
			// Value
			print "<td>";
			if (in_array($newkey, array('berp3_main_db_pass', 'berp3_main_auth_ldap_admin_pass'))) {
			...
			} elseif ($newkey == 'berp3_main_document_root_alt') {
			...
			} elseif ($newkey == 'berp3_main_instance_unique_id') {
				//print $conf->file->instance_unique_id;
				global $berp3_main_cookie_cryptkey, $berp3_main_instance_unique_id;
				$valuetoshow = $berp3_main_instance_unique_id ? $berp3_main_instance_unique_id : $berp3_main_cookie_cryptkey; // Use $berp3_main_instance_unique_id first then $berp3_main_cookie_cryptkey
				if (empty($berp3_main_prod)) {
					print '<!-- '.${$newkey}.' -->';
				...
				if (empty($valuetoshow)) {
					print img_warning("EditConfigFileToAddEntry", 'berp3_main_instance_unique_id');
				}
				print ' &nbsp; <span class="opacitymedium">('.$langs->trans("HashForPing").'='.md5('berp3'.$valuetoshow).')</span>';
			} elseif ($newkey == 'berp3_main_prod') {
				print ${$newkey};
			...
			} elseif ($newkey == 'berp3_nocsrfcheck') {
				print ${$newkey};
			...
			} elseif ($newkey == 'berp3_main_db_readonly') {
				print ${$newkey};
