...
## Integrate your ERP with any other applications using Berp3 APIs
 
This module provides the service to make Berp3 a server of REST Web Services. It depends on external library Restler.
...
<div align="center">
  <img class="imgdoc" src="https://www.berp3.org//images/doc_apirest.png" alt="Berp3 API explorer"/>
</div>
...
You can explore all available APIs by using the API explorer : [**yourberp3.tld**/api/index.php/explorer](../api/index.php/explorer) (replace **yourberp3.tld** by real hostname of your Berp3 installation)
...
https://**yourberp3.tld**/myberp3/api/index.php/otherservice?DOLAPIKEY=**api_key**
...
To implement it into Berp3, you need to create a specific class for object we want to use. A skeleton file is available into /modulebuilder/class directory : *api_mymodule_class.class.php* 
