 ...
 */
class modMyModule extends Berp3Modules
{
	/**
	...
	public function __construct($db)
	{
		...
		$this->numero = 500000; // TODO Go on page https://bonaerp.com/index.php/List_of_modules_id to reserve an id number for your module
