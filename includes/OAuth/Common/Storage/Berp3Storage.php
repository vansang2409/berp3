...
/**
 *      \file       htdocs/includes/OAuth/Common/Storage/Berp3Storage.php
 *      \ingroup    oauth
 *      \brief      Berp3 token storage class
 */
...
class Berp3Storage implements TokenStorageInterface
{
    /**
     ...
     */
    public function __construct(Berp3DB $db, $conf)
    {
        $this->db = $db;
        $this->conf = $conf;
        $this->tokens = array();
